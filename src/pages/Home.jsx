                                ...
                                <div class="container">
                                    <div class="row align-items-center justify-content-center justify-content-lg-start">
                                        <div class="col-10 col-lg-7 text-center text-lg-start">
                                            ...
                                            <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Car Repair and Car Booking Service</h1>
                                            <Link to="/shop/" class="btn btn-primary py-3 px-5 animated slideInDown">Book Now<i class="fa fa-arrow-right ms-3"></i></Link>
                                        </div>
                            ...
                            <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                                ...
                                <form  onSubmit={Onhandleform} method="post">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <textarea class="form-control border-0" placeholder="Special Request"
                                            name="message"
